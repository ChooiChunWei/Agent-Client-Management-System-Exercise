 ...
 * Use the [caseDetailsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class caseDetailsFragment(private val bundle: Bundle) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v =inflater.inflate(R.layout.fragment_case_details, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment caseDetailsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String, bundle: Bundle) =
            caseDetailsFragment(bundle).apply {
